<template>
    <div>
        <router-link class="menu-item" to="/scan">
            ...
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" width="30.239px" height="30.239px" viewBox="0 0 30.239 30.239"
		...
		C21.517,9.026,21.517,14.63,18.073,18.074z" style="fill: #2b79c3" />
                </g>
                <g>
                </g>
                <g>
        ...
        <router-link class="menu-item" to="/banList">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 60.123 60.123" style="enable-background:new 0 0 60.123 60.123;"
                xml:space="preserve">
                <g>
                    <path
        ...
        <a class="menu-item" href="https://t.me/PhishingDetectBot" target="_blank">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <path style="fill:white;" d="M165.323,267.452L395.89,125.446c4.144-2.545,8.407,3.058,4.849,6.359L210.454,308.684
	...
	C152.325,283.578,156.486,272.907,165.323,267.452z" />
                <path style="fill:#039be6;" d="M9.043,246.86l117.975,44.032l45.664,146.854c2.922,9.405,14.423,12.882,22.057,6.641l65.761-53.61
