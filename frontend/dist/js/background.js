...
chrome.webRequest.onBeforeRequest.addListener(function (details) {
  ...
  var cancel = Object.values(toggleSitesList).some(function (site) {
    var url = new URL(details.url);
  ...
  urls: ["<all_urls>"]
}, ["blocking"]); // any time a storage item is updated, update global variables
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/popup"], () => (__webpack_require__("./assets/css/popup.scss")))
